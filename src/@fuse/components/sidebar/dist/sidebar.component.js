...
exports.FuseSidebarComponent = void 0;
...
var FuseSidebarComponent = /** @class */ (function () {
    ...
    __decorate([
        core_1.Input()
    ], FuseSidebarComponent.prototype, "name");
    __decorate([
        core_1.Input()
    ], FuseSidebarComponent.prototype, "key");
    __decorate([
        core_1.Input()
    ], FuseSidebarComponent.prototype, "position");
    __decorate([
        core_1.HostBinding('class.open')
    ], FuseSidebarComponent.prototype, "opened");
    __decorate([
        core_1.Input()
    ], FuseSidebarComponent.prototype, "lockedOpen");
    __decorate([
        core_1.HostBinding('class.locked-open')
    ], FuseSidebarComponent.prototype, "isLockedOpen");
    __decorate([
        core_1.Input()
    ], FuseSidebarComponent.prototype, "foldedWidth");
    __decorate([
        core_1.Input()
    ], FuseSidebarComponent.prototype, "foldedAutoTriggerOnHover");
    __decorate([
        core_1.HostBinding('class.unfolded')
    ], FuseSidebarComponent.prototype, "unfolded");
    __decorate([
        core_1.Input()
    ], FuseSidebarComponent.prototype, "invisibleOverlay");
    __decorate([
        core_1.Output()
    ], FuseSidebarComponent.prototype, "foldedChanged");
    __decorate([
        core_1.Output()
    ], FuseSidebarComponent.prototype, "openedChanged");
    __decorate([
        core_1.HostBinding('class.animations-enabled')
    ], FuseSidebarComponent.prototype, "_animationsEnabled");
    __decorate([
        core_1.Input()
    ], FuseSidebarComponent.prototype, "folded");
    __decorate([
        core_1.HostListener('mouseenter')
    ], FuseSidebarComponent.prototype, "onMouseEnter");
    __decorate([
        core_1.HostListener('mouseleave')
    ], FuseSidebarComponent.prototype, "onMouseLeave");
