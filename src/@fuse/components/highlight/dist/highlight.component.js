...
require("projects/deck/src/@fuse/components/highlight/prism-languages");
var FuseHighlightComponent = /** @class */ (function () {
    ...
    __decorate([
        core_1.ContentChild('source', { static: true })
    ], FuseHighlightComponent.prototype, "source");
    __decorate([
        core_1.Input('lang')
    ], FuseHighlightComponent.prototype, "lang");
    __decorate([
        core_1.Input('path')
    ], FuseHighlightComponent.prototype, "path");
